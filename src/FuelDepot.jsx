...
export default function FuelDepot({fueled}){
 ...
 return <div className={`fuel-depot ${fueled?'fueled':''} ${transferring?'transferring':''}`} data-fueled={fueled}>
  <svg viewBox="0 0 941 1672" preserveAspectRatio="xMidYMid slice" aria-hidden="true"><path className="fuel-hose" d="M700 1210 C620 1280 487 1120 559 953"/>{fueled&&<path className="fuel-flow" d="M700 1210 C620 1280 487 1120 559 953"/>}</svg>
  <img src={fueled?'./scenes/fuel-depot-repaired.webp':'./scenes/fuel-depot.webp'} alt=""/>
  {fueled&&<span className="fuel-indicator">{transferring?'FUEL TRANSFER':'TANKS FULL'}</span>}
 </div>;
}
