...
export const exteriorRepairs=[
 {id:'exterior-hull',moves:25,room:'EXTERIOR',name:'Hull panels',icon:'◇',x:29,y:54,thought:'From here I can reach the damaged plating. Time to give this ship its skin back.',lesson:'A skin for the ship',objective:'Match 24 fuel cells to power the hull repair.',target:24,targetType:0,action:'Patch the hull',result:'The damaged panels are replaced. The ship has a solid hull again.',level},
 {id:'exterior-engines',moves:15,room:'EXTERIOR',name:'Engine nacelles',icon:'ϟ',x:82,y:54,thought:'The machinery inside is only half the job. These damaged housings and nozzle rings still need attention.',lesson:'Ready on the outside',objective:'Match 45 pieces to restore the nacelles and nozzles.',target:45,targetType:null,action:'Restore engine nacelles',result:'New housings protect the engines. The nozzle rings are aligned and the standby lights are on.',level},
 {id:'exterior-landing-gear',moves:30,room:'EXTERIOR',name:'Landing gear',icon:'▣',x:36,y:61,thought:'The landing struts locked during impact. Clear their protective covers and lift the hull off the rocks.',lesson:'Back on our feet',objective:'Match 45 pieces and release all 4 protective covers.',target:45,targetType:null,action:'Deploy landing gear',result:'Hydraulics press the footpads into the ground. The ship rises onto its landing legs, ready for the final checks.',level},
 {id:'exterior-refuel',moves:30,room:'EXTERIOR',name:'Emergency fuel depot',icon:'▣',x:77,y:72,thought:'The emergency fuel sled survived the landing. The internal lines are ready; now I need to repair its pump and transfer our reserve.',lesson:'Enough to reach the stars',objective:'Match 24 fuel cells to repair the pump and refuel the ship.',target:24,targetType:0,action:'Repair pump & refuel',result:'The pump is running. Fuel flows through the hose into the ship. Tanks filled — one more launch check complete.',level},
];
