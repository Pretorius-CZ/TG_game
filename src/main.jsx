...
function App() {
  ...
  const exploring=['system','mine','ice','wreck'].includes(scene);
  ...
  function goTo(next) {
    ...
    if(['system','mine','ice','wreck'].includes(next)&&!launchDone)return;
