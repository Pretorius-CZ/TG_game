...
export const crewRepairs = [
  {id:'crew-ventilation',moves:10, room:'CREW QUARTERS', name:'Air circulation', icon:'◎', x:25,y:23,
    thought:"The air has barely moved since the landing. Let's reconnect the fan and get this room breathing again.",
    lesson:'A breath of hope', objective:'Match 21 energy crystals to power the ventilation.', target:21,targetType:1,
    action:'Restore ventilation',result:'The fan is running and the duct is sealed. Fresh air can reach the cabin.',level:full},
  {id:'crew-filters',moves:14, room:'CREW QUARTERS', name:'Air filters',icon:'◇',x:77,y:24,
    thought:"The fan works, but the filter took a beating. A clean cartridge should clear the dust.",
    lesson:'Clear the air',objective:'Collect 18 blue comets and 18 stars to restore the filters.',target:36,targetType:null,
  ...
  {id:'crew-bunk',moves:16, room:'CREW QUARTERS',name:'Bunk',icon:'▱',x:25,y:48,
    thought:"I can't sleep in the pilot's seat forever. Let's make this bunk safe—and a little more comfortable.",
    lesson:'Somewhere to rest',objective:'Match 24 energy crystals to rebuild the bunk.',target:24,targetType:1,ice:[15,19,29,33],
    action:'Restore the bunk',result:'The bunks are secure, with fresh bedding ready for a proper rest.',level:full},
  {id:'crew-cabin',moves:18, room:'CREW QUARTERS',name:'Cabin systems',icon:'ϟ',x:76,y:49,
    thought:"A working desk, secure lockers and warm lights. Small things that make a ship feel like home.",
    lesson:'A place to call home',objective:'Collect 24 fuel cells and 24 crystals, and clear all covers.',target:48,targetType:null,ice:[8,12,22,26,36,40],
